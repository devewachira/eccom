        ...
        <div className='d-flex'>
          ...
          <div>
            <Container>
              ...
              <Row>
                <Col>
                  <span className='price'>{formatCurrency(suggestion.price)}</span>
                </Col>
              </Row>
            </Container>
          </div>
          ...
          <Container>
            <Row>
              ...
              <Col md='4' className='text-center d-none d-md-block'>
                ...
                <span>Call us +254743573360</span>
              </Col>
              <Col xs='12' className='text-center d-block d-md-none'>
                <i className='fa fa-phone' />
                <span> Need advice? Call us +254743573360</span>
              </Col>
            </Row>
          </Container>
        </div>
          ...
          <Row className='align-items-center top-header'>
            ...
            >
              <div className='brand'>
                ...
                <Link to='/'>
                  <h1 className='logo chrisub-logo'>
                    <span className='chrisub-logo-text'>Chris</span>
                    <i
                      className='fa fa-shopping-cart chrisub-logo-cart'
                      aria-hidden='true'
                    />
                    <span className='chrisub-logo-text'>ub</span>
                  </h1>
                </Link>
              </div>
            </Col>
